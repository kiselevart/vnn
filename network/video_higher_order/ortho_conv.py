...
class OrthoFusion(nn.Module):
    ...
    Cross-stream product forms a third feature stream, matching LaguFusion.
    """
    ...
    def __init__(self, basis_kind: str, num_classes: int,
        ...
        self.head      = OrthoHead(num_classes, basis_kind, num_ch=288,
...
def lvn_legendre_fusion(num_classes: int, clip_len: int = 16,
                        n_poly: int | None = None, alpha: float = 1.0) -> OrthoFusion:
    return OrthoFusion('legendre', num_classes, N_poly=n_poly, alpha=alpha, clip_len=clip_len)
...
def lvn_chebyshev_fusion(num_classes: int, clip_len: int = 16,
                         n_poly: int | None = None, alpha: float = 1.0) -> OrthoFusion:
    return OrthoFusion('chebyshev', num_classes, N_poly=n_poly, alpha=alpha, clip_len=clip_len)
...
def lvn_hermite_fusion(num_classes: int, clip_len: int = 16,
                       n_poly: int | None = None, alpha: float = 1.0) -> OrthoFusion:
    return OrthoFusion('hermite', num_classes, N_poly=n_poly, alpha=alpha, clip_len=clip_len)
